         ...
         <?php
              ...
              $erreurs = poster(); //Erreur avec fonction commenter()
         ?>
...
<head>
  ...
  <title>J.Forteroche - Admin</title>
...
<body>
      ...
      <section>
          <div class="container">
              ...
              <h2 class="text-poster"><i class="fas fa-feather-alt"></i> Poster un nouveau chapitre !</h2>
          
              <form action="" method="POST" enctype="multipart/form-data">  <!-- Enctype pour formulaire avec envoi/transfert de fichiers -->
                  <?php
                  if(isset($erreurs)) :
                  if($erreurs) :
                  ...
                  <div class="bloc-confirmation">
                     <p class="text-confirmation">Le chapitre a bien été posté !</p>
                  </div>
                  <?php
                  endif;
                  endif;
                  ...
                  <div class="champs">
                     ...
                     <input class="input" type="text" name="titre" placeholder="Titre *" value="<?php if(isset($_POST["titre"])) echo $_POST["titre"] ?>" minlength="2" maxlength="60" size="60">
                  </div>
                  <div class="champs-numero">
                    <label class="label" for="numero">Numero du chapitre :</label>
                    <input class="input" type="text" name="numero" placeholder="Numero *" value="<?php if(isset($_POST["numero"])) echo $_POST["numero"] ?>" minlength="1" maxlength="2" size="60">
                  </div>
                  <textarea id="tiny" name="contenu" placeholder="Corps du chapitre *"> <?php if(isset($_POST["contenu"])) echo $_POST["contenu"] ?></textarea>
                  <div class="champs-bouton">
                      <input class="bouton-envoyer-chapitre" type="submit"  value="Poster">
                  </div>
              </form>
          </div>
      </section>
